...
<body>
    <header id="header">
        ...
        <div>
            <a href=""><i>we need new workers</i></a>
        </div>
...
<div class="main-conteiner">
        ...
        <div class="developers">
         <div class="dev">
           <div><img class="foto-developer" src="/res/ya.jpg" alt=""></div>
            ...
            <div class="dev">
              <div><img class="foto-developer" src="https://media-exp2.licdn.com/dms/image/C4D03AQGEKtimVnnCAQ/profile-displayphoto-shrink_800_800/0/1656070867578?e=1661385600&v=beta&t=tW-yYjI3mVhAuFgBNrRkr1K1omyZw0jAnbpftoHScDk" alt=""></div>
              <h3>Ben</h3>
              <p>tel: 0507744439</p>
              <p><a href="facebooke.com"><i class="fa-brands fa-facebook-f"></i></a>
               <a href="https://www.instagram.com"><i class="fa-brands fa-instagram"></i></a>
    ...
    <script src="/htmlPizza/pizza.js"></script>
</body>
